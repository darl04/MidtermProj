...
<head>
    ...
    <style>
        :root {
            ...
            --text-color: #4a154b; /* Dark purple for text */
            --light-color: #fff5f9; /* Very light pink for background */
            --background-gradient: linear-gradient(135deg, #ff9a9e 0%, #fad0c4 100%);
        }
        ...
        .logout-container {
            ...
            box-shadow: 
                ...
                0 5px 10px rgba(255, 105, 180, 0.08);
            max-width: 500px;
            width: 100%;
        ...
        /* Add sparkle effect for a more dynamic look */
        .sparkle {
            position: absolute;
            background-color: white;
            width: 6px;
